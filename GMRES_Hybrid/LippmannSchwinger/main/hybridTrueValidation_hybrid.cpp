...
int main(int argc, char* argv[]) {
  ...
  // running GMRES
	...
	for (size_t i = 0; i < 100; i++) {
		...
		avgtimeGMRES += timeGMRES;
		cout << "GMRES solver: " << timeGMRES << endl;
	}
	cout << "avg GMRES solver: " << avgtimeGMRES/100.0 << endl;
	exit(0);
	// cout << "e_GMRES" << endl;
	...
	// for (size_t preconditioner_target_rank = 5; preconditioner_target_rank <= 25; preconditioner_target_rank+=10) {
		// double avgFact = 0.0;
		// double avgSolver = 0.0;
		// cout << "begining preconditioner" << endl;
		...
		// for (size_t i = 0; i < 100; i++) {
			...
			// avgSolver += timeHybrid;
			cout << timeHybrid << endl;
		...
		/////////////////////////////////////////
	// }
	// std::cout << "rank: " << preconditioner_target_rank << "	avg precond fact: " << avgFact/100.0 << "	avg hybrid solver: " << avgSolver/100.0 << std::endl;
// }
	// exit(0);
