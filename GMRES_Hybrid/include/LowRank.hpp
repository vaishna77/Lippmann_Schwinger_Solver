...
private:
    ...
    void rookPiv(Mat& L,  Mat& R, double rank_or_tolerance, int target_rank,
                 int n_row_start, int n_col_start,
                 int n_rows, int n_cols
                );

    void queenPiv(Mat& L,  Mat& R, double rank_or_tolerance, int target_rank,
                  int n_row_start, int n_col_start,
                  int n_rows, int n_cols
                 );

    void SVD(Mat& L,  Mat& R, double rank_or_tolerance, int target_rank,
             int n_row_start, int n_col_start,
             int n_rows, int n_cols
            );
    ...
    void RRQR(Mat& L,  Mat& R, double rank_or_tolerance, int target_rank,
              int n_row_start, int n_col_start,
              int n_rows, int n_cols
             );
...
public:
    ...
    void getFactorization(Mat& L,  Mat& R, double rank_or_tolerance = 1e-8, int target_rank=20,
