...
void LowRank::rookPiv(Mat& L, Mat& R, double tolerance_or_rank, int user_rank,
                     ...
                     )
{
    ...
    while(((tolerance_or_rank < 1) ?
          ...
          fabs(max) * tolerance * matrix_norm) && computed_rank < user_rank
...
void LowRank::queenPiv(Mat& L, Mat& R, double tolerance_or_rank, int user_rank,
                       int n_row_start, int n_col_start,
                       int n_rows, int n_cols
                      )
{
...
void LowRank::SVD(Mat& L,  Mat& R, double tolerance_or_rank, int user_rank,
                  int n_row_start, int n_col_start,
                  int n_rows, int n_cols
                 )
{
...
void LowRank::RRQR(Mat& L,  Mat& R, double tolerance_or_rank, int user_rank,
                   int n_row_start, int n_col_start,
                   int n_rows, int n_cols
                  )
{
...
void LowRank::getFactorization(Mat& L,  Mat& R, double tolerance_or_rank, int target_rank,
                               int n_row_start, int n_col_start,
                               int n_rows, int n_cols
                              )
{
    ...
    {
        int computed_rank;
        rookPiv(L, R, tolerance_or_rank, target_rank,
    ...
    {
        int computed_rank;
        queenPiv(L, R, tolerance_or_rank, target_rank,
                 n_row_start, n_col_start,
                 n_rows, n_cols
                );
    }
    ...
    {
        SVD(L, R, tolerance_or_rank, target_rank,
            n_row_start, n_col_start,
            n_rows, n_cols
           );
    }
    ...
    {
        RRQR(L, R, tolerance_or_rank, target_rank,
             n_row_start, n_col_start,
             n_rows, n_cols
            );
    }
